	...
	<div class="footer-bar haslayout">
		<div class="container">
			<div class="pull-left left">
				<p>&copy; <a href="{{url('home')}}">{{ Theme::place('title') }} {{ date('Y') }}</a> | All Rights Reserved. Powered by <a class="title-copyright" href="//jarvis-store.com" target="_blank"> Jarvis Store</a></p>
			</div>
